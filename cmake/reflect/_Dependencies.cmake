...
if( NOT OBJC_COMPAT_HEADER)
   ...
   if( OBJC_COMPAT_HEADER)
      ...
      # Disable with: `mulle-sourcetree mark objc-compat no-cmake-searchpath`
      #
      foreach( _TMP_OBJC_COMPAT_NAME IN LISTS _TMP_OBJC_COMPAT_NAME)
         set( _TMP_OBJC_COMPAT_DIR "${_TMP_OBJC_COMPAT_ROOT}/include/${_TMP_OBJC_COMPAT_NAME}")
         if( IS_DIRECTORY "${_TMP_OBJC_COMPAT_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_OBJC_COMPAT_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
