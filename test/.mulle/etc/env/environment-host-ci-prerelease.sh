...
#
# mulle-bunchobjects nodetype: ${MULLE_BUNCHOBJECTS_NODETYPE:-tar}
#
export MULLE_BUNCHOBJECTS_NODETYPE="git"


#
# mulle-bunchobjects url: ${MULLE_BUNCHOBJECTS_URL:-https://github.com/MulleFoundation/mulle-bunchobjects/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_BUNCHOBJECTS_URL="https://github.com/MulleFoundation/mulle-bunchobjects.git"


#
# mulle-bunchobjects branch: ${MULLE_BUNCHOBJECTS_BRANCH}
#
export MULLE_BUNCHOBJECTS_BRANCH="prerelease"
